        ...
        <div>
            ...
            <Container className='main-cheif-section' >
                ...
                <section className='chefss'>
                    ...
                    <section onMouseEnter={() => setShowIcons(true)} onMouseLeave={() => setShowIcons(false)}>
                    ...
                    <section onMouseEnter={() => setShowIcon2(true)} onMouseLeave={() => setShowIcon2(false)}>
                    ...
                    <section onMouseEnter={() => setShowIcon3(true)} onMouseLeave={() => setShowIcon3(false)}>
                    ...
                    <section onMouseEnter={() => setShowIcon4(true)} onMouseLeave={() => setShowIcon4(false)}>
                    ...
                    <section onMouseEnter={() => setShowIcon5(true)} onMouseLeave={() => setShowIcon5(false)}>
                    ...
                    <section onMouseEnter={() => setShowIcon6(true)} onMouseLeave={() => setShowIcon6(false)}>
            ...
            <Container className='skiiledTeam'>
                ...
                <div className='skilledOne'>
                    ...
                    <p>Bring tothe table survival strategies to ensured proactived domination At the end of the day, going forward, a new normal that has evolved from generation X is on the runway heading towards a streamlined touchpoints for offshoring.</p>
                    <h3>Experienced</h3>
                    <img src={line11} />
                    ...
                    <h3>Creative</h3>
                    <img src={line3} />
                    <button className='skilledButton'>
                        See All dishes
                    </button>
